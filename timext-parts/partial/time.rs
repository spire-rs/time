...
impl PartTime {
    /// Attempts to create a [`PartTime`] from the hour, minute, and second.
    pub fn from_hms(
        hour: Option<u8>,
        minute: Option<u8>,
        second: Option<u8>,
    ...
    /// Attempts to create a [`PartTime`] from the hour, minute, second, and millisecond.
    ...
    /// Attempt to create a [`PartTime`] from the hour, minute, second, and microsecond.
    ...
    /// Attempt to create a [`PartTime`] from the hour, minute, second, and nanosecond.
    ...
    /// Creates a [`PartTime`] from its components.
